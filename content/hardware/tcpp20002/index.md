...
{{% hardware-page %}}tcpp20002{{% /hardware-page %}}

## Technical details

The controller follows the standard [internal operation](/hardware/tech/console-controllers) of console controllers. In addition, only the first and fourth unmarked positions are available.
